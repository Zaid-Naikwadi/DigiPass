...
public class PaymentGatewayMainActivity extends BaseActivity implements View.OnClickListener {

    public static final String TAG = "PaymentGatewayMain: ";

    private String userMobile, userEmail;
    private SharedPreferences settings;
    private SharedPreferences.Editor editor;
    private SharedPreferences userDetailsPreference;
    private EditText email_et, mobile_et, amount_et,editTextPassType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPassType=(EditText)findViewById(R.id.activity_title_et);
    ...
    private void setUpUserDetails() {
        ...
        email_et.setText(Variables.UserEmail);
        email_et.setEnabled(false);
        int Ticket_price = getIntent().getExtras().getInt("price");
        mobile_et.setText(Variables.UserMobileNumber);
        mobile_et.setEnabled(false);
        String p_type=getIntent().getStringExtra("p_type");

        editTextPassType.setText(p_type);
        editTextPassType.setEnabled(false);
        amount_et.setText(""+Ticket_price);
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(PaymentGatewayMainActivity.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(PaymentGatewayMainActivity.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected int getLayoutResource() {
        return R.layout.activity_payment_gateway_main;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("PaymentGatewayMain", "request code " + requestCode + " resultcode " + resultCode);
        if (requestCode == PayUmoneyFlowManager.REQUEST_CODE_PAYMENT && resultCode == RESULT_OK && data !=
            ...
            if (transactionResponse != null && transactionResponse.getPayuResponse() != null) {
                if (transactionResponse.getTransactionStatus().equals(TransactionResponse.TransactionStatus.SUCCESSFUL)) {
                    ...
                    Intent intentgenerate = new Intent(PaymentGatewayMainActivity.this,GenerateQRCode.class);
             ...
             /*   new AlertDialog.Builder(this)    change kelaeyy
                        .setCancelable(false)
...
/*            *//**
           ...
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PaymentGatewayMainActivity.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PaymentGatewayMainActivity.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PaymentGatewayMainActivity.this);
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(PaymentGatewayMainActivity.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
